            ...
            if (caseAround.getWeight().getWeight() < 0) {
                ...
                for (Case caseAroundTheCaseAround : board.getCasesAround(caseAround)) {
                    if (caseAroundTheCaseAround.getWeight().equals(SAFE)
                        ...
                        caseMesCouilles = caseAroundTheCaseAround;
                    }
                }
                if (count > 2 && caseMesCouilles != null) {
                    board.setCaseWeight(caseMesCouilles, WUMPUS);
                }
                ...
                if (count > 2 && caseMesCouilles != null) {
                    board.setCaseWeight(caseMesCouilles, PIT);
                }
            }
        }
    }
